        ...
        <div class="flex flex-col gap-3 w-full md:w-1/3 mx-auto mb-3">
            <div class="edit-form min-w-full row-span-2">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="names" id="names" value="{{old('names')}}" min="1" max="255" required/>
                </div>

                {{-- Input: Apellidos --}}
                <div class="mb-3">
                    <label for="surnames" class="form-label">Apellidos</label>
                    <input type="text" class="form-control" name="surnames" id="surnames" value="{{old('surnames')}}" min="1" max="255" required/>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select form-select" name="brand_id">
                        ...
                        @foreach ($document_types as $document_type)
                            @if (old('document_type_id') == $document_type->id)
