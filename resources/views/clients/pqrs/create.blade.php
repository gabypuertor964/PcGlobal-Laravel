...
@section('content_header')
    <h1 class="text-center font-weight-bold font-italic">Crear PQRS</h1>
@stop
...
@section('content')
    ...
    <div class="edit-form min-w-full justify-center">
        {{-- Formulario --}}
        <form action="{{ route("clients.pqrs.store") }}" method="post" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-2 gap-3">
            {{-- Token de seguridad --}}
            @csrf
            ...
            <section>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="title" id="title" value="{{old('title')}}" min="1" max="50" required/>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select form-control" name="pqrs_type_id">
                        ...
                        @foreach ($pqrs_types as $pqrs_type)
                            @if (old('pqrs_type_id') == $pqrs_type->id)
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="date_ocurrence" id="date_ocurrence" value="{{old('date_ocurrence')}}" min="{{ now()->subDays(30)->format('Y-m-d') }}" max="{{now()->format('Y-m-d')}}"/>
                </div>                
            </section>
